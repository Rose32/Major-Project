...
SamplesPerModel = 1000; % hard limit the number of features 
OS = 'linux';
...
save('./NNData/LPQModelMap','ModelMap');
save('./NNData/LPQTargets','Targets');
save('./NNData/LPQTotalFeatures','TotalFeatures');